...
export default function PantallaCodigoContraseñaDisp({ navigation }) {
    ...
    const confirmChangeDevicePassword = async (codigo) => {
        ...
        const peticion = await axios.post("http://proyecto-backend-movil-production.up.railway.app/app_movil_sensor/api/device/confirm-change-device-password", notification, headers)
            .then(async res => {
